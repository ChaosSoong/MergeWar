...
(function() {
        ...
        if (a) {
            ...
            var e = function(a) {
                    ...
                    nb = o, setTimeout(function() {
                        ...
                        ob.src = z.ma + "images/blank.gif?" + a.src  //Ö±½Ó´Ó±¾µØÄÃÊý¾Ý
                    }, 50))
                },
                f = function() {
                    var a = pb.shift();
    ...
    z.JX = {
        ...
        main_domain_nocdn: {
            ...
            //baidu:lpyhtj+'/'+"getMapData.php"
			//baidu:lpyhtj+"/CommonMap/getMapData"
             // baidu:"127.0.0.1/getMapData.php"
        },
        main_domain_cdn: {
    ...
    z.url = z.G_[z.ou];
    z.mp = z.url.proto + z.url.domain.baidumap + "/Map/";
    z.Fc = z.url.proto + ("2" == z.ou ? z.url.domain.main_domain_nocdn.other : z.url.domain.main_domain_nocdn.baidu) + "/Map/";
    z.ma = z.url.proto + ("2" == z.ou ? z.url.domain.main_domain_cdn.other[0] : z.url.domain.main_domain_cdn.baidu[0]) + "/Map/";
    z.ej = z.url.proto + z.url.domain.main_domain_cdn.webmap[0] + "/Map/";
    z.tg = function(a, b) {
        var c, d, b = b || "";
        switch (a) {
    ...
    Uc.getTilesUrl = function(a, b, c) {
        ...
        abc='../../Map/maptile/'+b+'/'+(d + "").replace(/-/gi, "M")+'/'+(a + "").replace(/-/gi, "M")+'.jpg';
        return abc;
    };
    var La = new Qc("\u5730\u56fe", Uc, {
            tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",

...
(function() {
    ...
    d.prototype._initialize = function(h, g) {
        this._map = h;
        this._opts = g;
        this._drawingType = g.drawingMode;
    ...
    d.prototype._bindRectangle = function() {
        ...
        var g = function(p) {
            ...
            j = null;
            var tmp=[],parent=Date.parse(new Date())/1000;
...
//            $.ajax({
//                type: "Post",
//                url: strProto+lpyhtj+"/CommonMap/GetLatData",
//                dataType: "json",
//                data:{ temp:tmp},
//                //async: false,
...
//                        jsonHtml+="场所名称："+data[bb].Name+"，经纬度："+data[bb].lng+","+data[bb].lat+"<br>";
//                    }
//                    $("#mapHtml").html(jsonHtml);
//                },
...
//            });
    ...
    function a(h, g) {
        ...
        this.defaultDrawingModes = [BMAP_DRAWING_RECTANGLE];
        if (g.drawingModes) {
